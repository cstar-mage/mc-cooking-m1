...
*/
class MD_Membership_Block_Adminhtml_Subscribers_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection() {
        ...
        $collection->getSelect()
                    ->joinLeft(array('p1'=>Mage::getSingleton('core/resource')->getTableName('md_membership/plans')),'p1.plan_id=main_table.plan_id',array('p1.title'));
