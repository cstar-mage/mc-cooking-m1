...
class MageWorx_CustomOptions_Helper_Data extends Mage_Core_Helper_Abstract {
    ...
    // $model is Mage_Catalog_Model_Product_Option or Mage_Catalog_Model_Product_Option_Value object
    public function getOptionPriceByQty($model, $qty)
    {
        ...
        if ($model->getSpecialPrice()!=0) {
            ...
            } else if ($price!=0 && $model->getPriceType()==MageWorx_CustomOptions_Model_Catalog_Product_Option::PRICE_TYPE_OPTIONS_PERCENT) {
                ...
                foreach ($tiers as $tier) {
                    if ($qty>=$tier['qty'] && ($tier['customer_group_id']==Mage_Customer_Model_Group::CUST_GROUP_ALL || $tier['customer_group_id']==$customerGroupId)) {
                        ...
                        if ($tier['price_type']=='percent' && $tierPrice!=0) {   
                            ...
                            } else if ($model->getPriceType()==MageWorx_CustomOptions_Model_Catalog_Product_Option::PRICE_TYPE_OPTIONS_PERCENT) {
